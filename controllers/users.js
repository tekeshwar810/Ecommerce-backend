...
exports.signup = async(req,res)=>{
    ...
    let userResp = await datas.save()
    let userId = datas._id
    console.log(userId)
        res.status(200).json({ msg:"User signup successfully",success:false,data:userResp}) 
    }catch(error){
        console.log(error)
        res.status(500).json({ msg:"User not add",success:false,data:null}) 
    }
    ...
    //     }
         ...
         res.status(400).json({ msg:"email already exist",success:false,data:null}) 
...
exports.signin = async(req,res)=>{
            ...
            res.status(200).json({msg:'user login successfully',success:true,data:{
                username:'tekeshwar',
                email:"tekeshwar@gmail.com",
                dob:"31-12-1996",
                address:"Behind Miraj Takies"
            }})
...
exports.list_user = async(req,res)=>{
    ...
    res.status(200).json({msg:'user list',data:users,success:true})
